...
interface CloneDataDialogProps {
  onClone: (sourceYear: number, sourceMonth: number, targetYear: number, targetMonth: number) => void;
}

const CloneDataDialog: React.FC<CloneDataDialogProps> = ({ onClone }) => {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Select source and target year/month to clone revenue data.
          </DialogDescription>
        </DialogHeader>
...
export default CloneDataDialog;
