...
import { TrendingUp, Search, Download, DollarSign, Receipt, Users } from "lucide-react";
...
import { MONTHS, YEARS as years } from "@/lib/months";
...
} from "@/hooks/useCustomerReportData";

type CustomerReportData = GroupedCustomerData;
...
const CustomerReport = () => {
  ...
  const { groupedData, loading } = useCustomerReportData({
    selectedYear,
    selectedMonths,
  });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        <StatCards groups={[{ label: `Customer Performance ${selectedYear}`, stats: summaryStats }]} />
